...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("WorldFishCenter/peskas.kenyar.data.pipeline", fork = TRUE)`.
...
Please note that the peskas.kenyar.data.pipeline project is released
with a [Contributor Code of
Conduct](https://worldfishcenter.github.io/peskas.zanzibar.data.pipeline/CODE_OF_CONDUCT.md).
