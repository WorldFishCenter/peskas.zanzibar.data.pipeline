...
and a taxon FishBase cannot resolve had no bound at all — so a missing
bound passed silently. That covered 21.6% of rows carrying a length,
including every `MZZ` row, and is how a 130,000 cm fish reached the API.
